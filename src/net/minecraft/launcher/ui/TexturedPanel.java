	...
	public TexturedPanel(String filename) {
		...
		try {
			this.bgImage = ImageIO.read(
					TexturedPanel.class.getResource(filename))
					.getScaledInstance(32, 32, 16);
		} catch (IOException e) {
			Launcher.getInstance().println(
					"Unexpected exception initializing textured panel", e);
		}
	}
 ...
 * net.minecraft.launcher.ui.TexturedPanel JD-Core Version: 0.6.2
 */